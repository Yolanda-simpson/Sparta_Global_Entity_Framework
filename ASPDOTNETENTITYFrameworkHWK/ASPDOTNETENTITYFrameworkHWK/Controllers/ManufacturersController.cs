...
namespace ASPDOTNETENTITYFrameworkHWK.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ManfucatorName,ManufacurerLocation")] Manufacturer manufacturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ManfucatorName,ManufacurerLocation")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
